...
export default function ExamTest({ auth, role, newregn, theme }) {
                                    ...
                                    <div className="col-xxl-12">
                                        <div className="card radius-12 border-0">
                                            <div
                                                ...
                                                <h6 className="mb-2 fw-bold text-lg">Counselling</h6>
                                                    ...
                                                    <table className="table bordered-table mb-0 data-table" id="dataTable"
                                                        ...
                                                        <tbody>
                                                            {registration.data && registration.data.map((item, index) => {
                                                                    ...
                                                                    let studentname = item.first_name + " " + item.last_name;
